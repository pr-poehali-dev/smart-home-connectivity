        ...
        <div className="grid md:grid-cols-2 gap-12 items-center">
          ...
          <div className="flex flex-col gap-6">
            <div className="inline-flex items-center gap-2 bg-accent/10 text-accent px-4 py-2 rounded-full w-fit">
              ...
              <span className="text-sm font-medium">Работаем в Екатеринбурге</span>
            </div>
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-foreground leading-tight text-balance">
              Профессиональный электромонтаж для вашего дома и офиса
            </h1>
            <p className="text-lg text-muted-foreground leading-relaxed">
              Качественные электромонтажные работы любой сложности. Опытные специалисты,
              сертифицированное оборудование, гарантия на все виды работ.
            </p>
            ...
            <div className="flex gap-8 pt-4 text-sm">
              <div>
                ...
                <p className="text-muted-foreground">Выполненных объектов</p>
              </div>
              <div>
          ...
          <div className="relative h-96 md:h-full min-h-96">
            ...
            <img
              ...
              alt="Электромонтажные работы в Екатеринбурге"
